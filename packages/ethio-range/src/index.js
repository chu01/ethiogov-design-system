 ...
 * @example
 *
 * <input id="ethio-range" class="ethio-range" type="range" min="0" max="100" step="10" value="20" data-text-unit="degrees">
 *
 * Callout returns "20 degrees of 100."
 *
 * <input id="ethio-range" class="ethio-range" type="range" min="0" max="100" step="10" value="20" data-text-preposition="de">
 *
