...
const debounce = require("../../ewds-core/src/js/utils/debounce");
...
/**
 * Move maxlength attribute to a data attribute on ethio-character-count
 *
 * @param {HTMLInputElement|HTMLTextAreaElement} inputEl The character count input element
 */
 ...
 *
 * @param {HTMLDivElement} characterCountEl - Div with `.ethio-character-count` class
...
const createStatusMessages = (characterCountEl) => {
  ...
  statusMessage.classList.add(`${STATUS_MESSAGE_CLASS}`, "ethio-hint");
...
const enhanceCharacterCount = (inputEl) => {
  ...
  messageEl.classList.add("ethio-sr-only");
