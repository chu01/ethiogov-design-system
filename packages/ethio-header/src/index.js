...
const FocusTrap = require("../../ewds-core/src/js/utils/focus-trap");
const accordion = require("../../ethio-accordion/src/index");
const ScrollBarWidth = require("../../ewds-core/src/js/utils/scrollbar-width");
...
const ACTIVE_CLASS = "ethio-js-mobile-nav--active";
...
const INITIAL_PADDING = window
  .getComputewdstyle(document.body)
 ...
 * More details in https://github.com/ewds/ewds/pull/5443
 */
...
const toggleNav = (active) => {
  ...
  if (safeActive && closeButton) {
    ...
    !safeActive &&
    menuButton &&
    getComputewdstyle(menuButton).display !== "none"
  ) {
